execute if score Seconds Timer matches ..4 run scoreboard players add Seconds Timer 1
execute if score Seconds Timer matches 5.. run scoreboard players add Minutes Timer 1
execute if score Seconds Timer matches 5.. run scoreboard players set Seconds Timer 0
